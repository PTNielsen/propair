  ...
  def bot_message
    SlackApi.post "/chat.postMessage",
      body: {
        ...
        text:     "If you'd like to pair remotely using Screenhero, please enter '/hero @PARTNER_USERNAME' to begin a screensharing session. ** IMPORTANT NOTE:  Use of Slack's Screenhero integration requires an existing Screenhero account with the same email address as your Slack account.  To sign up for a free account, please visit https://screenhero.com/login **"
